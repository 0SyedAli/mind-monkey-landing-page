        ...
        <div className="container">
          <div className="row align-items-center row-gap-4 row-lg-gap-5">
            ...
            <div className="col-lg-6">
              ...
              >
                {/* <h2>Lorem Ipsum</h2> */}
                <p>Mind Monkey is brought to you by Phoenix Institute for Wellness, a non-profit organization dedicated to providing Mental/Spiritual Health support for free to individuals in need. Mind Monkey is designed to assist, guide and inform individuals as they journal experiences and create your path forward. Users will find warmth and acceptance as they note occurrences and track daily emotions, follow trends  and customize the app to meet your own unique needs. Fun and designed for all ages, Mind Monkey aims to bridge the gap between mainstream approaches to mental and spiritual health, while reminding users of their worth and higher purpose. Explore new ways to check in with YOU so that you can work your way to being the best version of Self! Being the best version of yourself will inspire others to do the same! Mind Monkey serves as your guide to higher consciousness, expanding your relations with the universe at large!</p>
